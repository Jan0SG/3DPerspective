...
namespace Perspectiva_3D
{
    public class Scene
    {
        ...
        public Pen pen = new Pen(Color.YellowGreen, 5);
        public int angle;
        ...
        public void Draw(Graphics graphics, int viewWidth, int viewHeight)
        {
            ...
            // Draw x-axis
            graphics.DrawLine(new Pen(Color.IndianRed), 0, viewHeight / 2, viewWidth, viewHeight / 2);

            // Draw y-axis
            graphics.DrawLine(new Pen(Color.BlueViolet), viewWidth / 2, 0, viewWidth / 2, viewHeight);
            ...
            for (var i = 0; i < figure.Vertices.Length; i++)
            {
                ...
                projected[i] = transformed.Project(viewWidth, viewHeight, 256, 7);
            }
